...
ppl_zend_v2 = dnnlib.EasyDict(func_name='metrics.perceptual_path_length_v2.PPLV2', name='ppl_zend_v2', num_samples=100000, epsilon=1e-4, space='z', sampling='end', minibatch_per_gpu=16)
...
class MetricBase:
    ...
    def run(self, network_pkl, run_dir=None, dataset_args=None, mirror_augment=None, num_gpus=1, tf_config=None, log_results=True, use_RA=True):
